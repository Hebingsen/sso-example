...
/**
 * 版本问题，spring-data-redis 2.0版本中set(String,String)被弃用了
 * 所以自己重新将所有conn.set(…)都换成conn..stringCommands().set(…)
 * @作者 hebingsen
 * @时间 2018年6月27日
 */
@Component
public class Oauth2CustomRedisTokenStore implements TokenStore {
	...
	public Oauth2CustomRedisTokenStore(RedisConnectionFactory connectionFactory) {
